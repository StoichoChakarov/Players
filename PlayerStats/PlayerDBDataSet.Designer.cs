...
namespace PlayerStats {
    ...
    public partial class PlayerDBDataSet : global::System.Data.DataSet {
        ...
        public partial class PlayerDataTable : global::System.Data.TypedTableBase<PlayerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PlayerRow AddPlayerRow(int Id, string name, int points) {
        ...
        public partial class PlayerRow : global::System.Data.DataRow {
            ...
            public int points {
                get {
                    try {
                        return ((int)(this[this.tablePlayer.pointsColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'points\' in table \'Player\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablePlayer.pointsColumn] = value;
                }
            }
            ...
            public bool IspointsNull() {
                return this.IsNull(this.tablePlayer.pointsColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetpointsNull() {
                this[this.tablePlayer.pointsColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace PlayerStats.PlayerDBDataSetTableAdapters {
    ...
    public partial class PlayerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Player] WHERE (([Id] = @Original_Id) AND ((@IsNull_points = 1 " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Player] ([Id], [name], [points]) VALUES (@Id, @name, @points);" +
                "\r\nSELECT Id, name, points FROM Player WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Player] SET [Id] = @Id, [name] = @name, [points] = @points WHERE ((" +
                "[Id] = @Original_Id) AND ((@IsNull_points = 1 AND [points] IS NULL) OR ([points]" +
                " = @Original_points)));\r\nSELECT Id, name, points FROM Player WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PlayerStats.Properties.Settings.Default.PlayerDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, points FROM dbo.Player";
        ...
        public virtual int Insert(int Id, string name, global::System.Nullable<int> points) {
        ...
        public virtual int Update(int Id, string name, global::System.Nullable<int> points, int Original_Id, global::System.Nullable<int> Original_points) {
            ...
            if ((Original_points.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(Original_points.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, global::System.Nullable<int> points, int Original_Id, global::System.Nullable<int> Original_points) {
            return this.Update(Original_Id, name, points, Original_Id, Original_points);
        }
    }
